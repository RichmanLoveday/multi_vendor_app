                                        ...
                                        <form method="POST" action="{{ route('vendor.register') }}">
                                            ...
                                            <div class="form-group">
                                                <input type="text" required="" id="name" name="name"
                                                    value="{{ old('name') }}" required placeholder="Shop Name" />
                                            </div>
                                            <div class="form-group">
                                                <input type="text" required="" id="username" name="username"
                                                    value="{{ old('username') }}" required placeholder="User name" />
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                <select name="vendor_join" id="vendor_join" class=" form-select mb-3">
                                                    <option value="" selected>Select Join Date</option>
