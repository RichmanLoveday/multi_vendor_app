									...
									<div class="form-body">
										<form class="row g-3" method="POST" action="{{ route('login') }}">
											...
											<div class="col-12">
												...
												<input type="email" id="email" :value="old('email')" class="form-control" name="email" placeholder="Email Address">
											</div>
											<div class="col-12">
											...
											<div class="col-12">
												<div class="d-grid">
													<button type="submit" class="btn btn-primary"><i class="bx bxs-lock-open"></i>Sign in</butt>
												</div>
											</div>
										</form>
									</div>
