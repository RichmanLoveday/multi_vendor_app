                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9 text-secondary">
                                        <select class="form-select mb-3" name="vendor_join" aria-label=".form-select-lg example">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9 text-secondary">
                                        <textarea class="form-control" style="resize: none" id="vendor_short_info" name="vendor_short_info" placeholder="vendor_short_info" rows="3" style="height: 100px;">{{ $vendorData->vendor_short_info }}</textarea>
                                    </div>
                                </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9 text-secondary">
                                        <img id="showImage" src="{{ !empty($vendorData->photo) ? url('upload/vendor_images/'. $vendorData->photo) : url('upload/no_image.jpg') }} " alt="vendor" class="" style="width: 100px; height:100px;">
                                    </div>
                                </div>
