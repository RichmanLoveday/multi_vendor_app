...
@section('vendor')
    ...
    <div class="page-content">
        ...
        @else
            <h4>Vendor Account is <span class="text-dange">Inactive</span></h4>
            <p class="text-danger font-bold">Please wait admin will check and approve your account</p>
        @endif
                            ...
                            <tbody>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <div class="recent-product-img">
                                                <img src="{{ asset('admin_backend/assets/images/icons/chair.png') }}"
                                                    alt="">
                                            </div>
                                            <div class="ms-2">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <div class="recent-product-img">
                                                <img src="{{ asset('admin_backend/assets/images/icons/shoes.png') }}"
                                                    alt="">
                                            </div>
                                            <div class="ms-2">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <div class="recent-product-img">
                                                <img src="{{ asset('admin_backend/assets/images/icons/headphones.png') }}"
                                                    alt="">
                                            </div>
                                            <div class="ms-2">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <div class="recent-product-img">
                                                <img src="{{ asset('admin_backend/assets/images/icons/idea.png') }}"
                                                    alt="">
                                            </div>
                                            <div class="ms-2">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <div class="recent-product-img">
                                                <img src="{{ asset('admin_backend/assets/images/icons/user-interface.png') }}"
                                                    alt="">
                                            </div>
                                            <div class="ms-2">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <div class="recent-product-img">
                                                <img src="{{ asset('admin_backend/assets/images/icons/watch.png') }}"
                                                    alt="">
                                            </div>
                                            <div class="ms-2">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <div class="recent-product-img">
                                                <img src="{{ asset('admin_backend/assets/images/icons/tshirt.png') }}"
                                                    alt="">
                                            </div>
                                            <div class="ms-2">
