                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form id="myForm" method="post" action="{{ route('update.slider') }}"
                                    ...
                                    <input type="hidden" name="slider_image" value="{{ $sliders->slider_image }}">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="form-group col-sm-9 text-secondary">
                                            <input type="text" name="slider_title" value="{{ $sliders->slider_title }}"
                                                class="form-control" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="form-group col-sm-9 text-secondary">
                                            <input type="text" name="short_title" value="{{ $sliders->short_title }}"
                                                class="form-control" />
                                        </div>
                                    </div>
