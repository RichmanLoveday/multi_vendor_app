                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-9 text-secondary">
                                            <textarea class="form-control" style="resize: none" id="vendor_short_info" name="vendor_short_info"
                                                placeholder="vendor_short_info" rows="3" style="height: 100px;">{{ $inactiveVendorDetails->vendor_short_info }}</textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-9 text-secondary">
                                            <img id="showImage"
                                                ...
                                                alt="vendor" class="" style="width: 100px; height:100px;">
                                        </div>
                                    </div>
